        ...
        success: function (doctors) {
            ...
            $.each(doctors, function (p, doctor) {
                $('.cards-warpper').append('<div class="card card-number-'  + doctor.id + '">\n' +
                    ...
                    '<h1 class="doctor_name">Name: ' + doctor.name + '</h1>\n' +
                    '<h5 class="price">Price: ' + doctor.price + '</h5>\n' +
                    ...
                    '<h5 class="discount">Discount: ' + doctor.discount + '</h5>\n' +
                    '<h5 class="description" style="overflow: hidden;">Description: ' + doctor.description + '</h5>\n' +
                    '<h5>Create date: ' + doctor.added + '</h5>\n' +
                    '<h5>Update date: ' + doctor.updated + '</h5>\n' +
                    '<h5 class="category">Category: ' + doctor.category + '</h5>\n' +
                    '</div>');
            });
        },

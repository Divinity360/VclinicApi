            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('.cards-warpper').prepend('<div class="card card-number-'  + response.id + '">\n' +
                        ...
                        '<h1 class="doctor_name">Doctor Name: ' + response.name + '</h1>\n' +
                        '<h5 class="price">Doctor Charges Price: ' + response.price + '</h5>\n' +
                        '<h5 class="phone">Phone: ' + response.phone + '</h5>\n' +
                        '<h5>Number of views: ' + 0 + '</h5>\n' +
                        '<h5>Number of sales: ' + 0 + '</h5>\n' +
                        // '<h5>Files: ' + response.files + '</h5>\n' +
                        '<h5 class="discount">Price Discount (%): ' + response.discount + '</h5>\n' +
                        ...
                        '<h5 class="category">Doctors Posiition: ' + response.category + '</h5>\n' +
                        '</div>');
